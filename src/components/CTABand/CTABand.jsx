...
const CTABand = () => {
    const agencyEmail = 'hello@xcendlabs.com';
    const whatsappNumber = '1234567890'; // Replace with actual number
    const whatsappMessage = encodeURIComponent('Hi! I\'m interested in learning more about XcendLabs services.');

    return (
        <section className={`${styles.ctaBand} section theme-a`}>
                ...
                <div className={styles.band}>
                    ...
                    <div className={styles.buttons}>
                        ...
                        <a
                            ...
                            className={`${styles.btnSecondary} ${styles.btnEmail}`}
                        >
                            <EmailIcon />
                            Email Us
                        </a>
